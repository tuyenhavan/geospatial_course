...
| Bài số | Nội dung                                                                                                                       |
| ------ | ------------------------------------------------------------------------------------------------------------------------------ |
| 31     | Phân loại lớp phủ mặt đất - Random Forest trên ảnh vệ tinh Sentinel-2                                                    |
...
Các tập dữ liệu mẫu sử dụng trong khóa học được lưu trong thư mục `data/` và tại các đường dẫn trong bài học.
