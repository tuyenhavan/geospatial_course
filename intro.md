...
| 29     | Tính toán các chỉ số ảnh quang học và Radar (Microsoft Planetary Computer) |
| 30     | Xử lý dữ liệu lớn (Microsoft Planetary Computer)                           |
| 31     | Truy cập và xử lý dữ liệu Copernicus (Copernicus Data Space Ecosystem)     |
...
| Bài số | Nội dung                                                                                                                       |
| ------ | ------------------------------------------------------------------------------------------------------------------------------ |
| 32     | Phân loại lớp phủ mặt đất - Random Forest trên ảnh vệ tinh Seninel-2                                                    |
| 33     | Theo dõi hạn hán (Drought monitoring) - Phân tích chỉ số hạn hán với dữ liệu MODIS và ERA5                                     |
