...
| 34     | Ước tính chiều cao tán cây (Vegetation canopy height) - Sử dụng ảnh Sentinel-2 kết hợp mô hình hồi quy học sâu (Deep learning) |
| 35     | Phân vùng mặt nước (Water body segmentation) - Sử dụng ảnh Sentinel-2 và mô hình học sâu (Deep learning)                       |
