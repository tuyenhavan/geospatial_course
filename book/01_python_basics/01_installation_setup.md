...
- **Cách ly dự án**: Mỗi dự án có thư viện riêng biệt
- **Quản lý phiên bản**: Tránh xung đột giữa các phiên bản thư viện
- **Tái tạo được**: Dễ dàng chia sẻ và tái tạo môi trường
- **An toàn**: Không ảnh hưởng đến Python system
- **Dễ dọn dẹp**: Xóa toàn bộ môi trường khi không cần.
...
conda list
```
#### Các thư viện khoa học dữ liệu cốt lõi
...
##### Các thư viện Python cho dữ liệu địa không gian
...
**Giải pháp**: Kiểm tra kích hoạt môi trường và cài đặt các gói cần thiết và extension
```bash
conda activate geotest
