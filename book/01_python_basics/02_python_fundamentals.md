...
Trong bài học này, chúng ta sẽ đề cập đến các khối xây dựng cơ bản của lập trình Python. Bài học này có [video](https://www.youtube.com/watch?v=aFI6suhmjhQ&t=6s) kèm theo.
...
Trong Python, có nhiều hàm và công cụ toán học có sẵn giúp người dùng thực hiện các phép tính một cách nhanh chóng và chính xác.
