...
file = r'G:\My Drive\python\python_course\book\data\outputs\cities.txt'
...
```python
# Ghi dữ liệu dân số vào file
populations = [8053663, 9420000, 1134000, 2028220, 1235000] 
outfile = r'G:\My Drive\python\python_course\book\data\outputs\populations.txt'
...
outfile = r'G:\My Drive\python\python_course\data\outputs\city_data.csv'
# Tạo dự liệu mẫu 
...
```python
file = r'G:\My Drive\python\python_course\data\outputs\city_data.csv'
