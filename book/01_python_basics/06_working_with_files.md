...
file = r'G:\My Drive\python\geocourse\data\excels\cities.txt' # đường dẫn file để lưu dữ liệu. Bạn thay thế bằng file của bạn.
...
outfile = r'G:\My Drive\python\geocourse\data\excels\city_data.csv' # đường dẫn file để lưu dữ liệu. Bạn thay thế bằng file của bạn.
# Tạo dữ liệu mẫu 
...
```python
file = r'G:\My Drive\python\geocourse\data\excels\city_data.csv'
