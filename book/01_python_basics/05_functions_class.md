...
Hàm (function) là blocks của code có thể tái sử dụng để thực hiện một tác vụ cụ thể.
...
`List comprehension` được sử dụng để tạo ra một danh sách mới bằng cách áp dụng một biểu thức cho mỗi phần tử trong một iterable (như list, tuple, v.v.) và có thể bao gồm điều kiện lọc.
