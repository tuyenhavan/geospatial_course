# Bài 31: Truy cập dữ liệu Copernicus Data Space Ecosystem (CDSE)
...
- `Cách 1`: Có thể thiết lập environment variables với conda chỉ một lần:
```bash
...
- `Cách 2`: Authenticate trực tiếp trong notebook như sau (phải thiết lập cho mỗi notebook).
...
## 31.3. Kết nối và khám phá CDSE STAC Catalog

### 31.3.1. Kết nối STAC Catalog
...
### 31.3.2. Tìm kiếm dữ liệu Sentinel-2
...
### 31.3.3. Xem thông tin thuộc tính của bức ảnh
...
## 31.4. Đọc dữ liệu từ CDSE với odc-stac
...
### 31.4.1. Đọc tất cả dữ liệu theo `AOI`
...
### 31.4.2.  Đọc dữ liệu theo  `image id`
